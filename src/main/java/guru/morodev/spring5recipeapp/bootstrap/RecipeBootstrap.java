package guru.morodev.spring5recipeapp.bootstrap;

import guru.morodev.spring5recipeapp.domain.*;
import guru.morodev.spring5recipeapp.repositories.CategoryRepository;
import guru.morodev.spring5recipeapp.repositories.RecipeRepositories;
import guru.morodev.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
/**
 * Created by Luca Moro on 27/10/2020 19:02
 */
@Slf4j
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepositories recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
